        ...
        {items.map((category) => {
          ...
          return (
            <Link
              ...
              className="group inline-flex min-w-36 shrink-0 items-center gap-2 min-h-12 rounded-full border border-surface-border-subtle bg-surface-panel py-1.5 pl-1.5 pr-3 text-text-muted-strong outline-none snap-start transition-colors hover:border-control-border-strong hover:text-foreground active:scale-[0.97] focus-visible:ring-[3px] focus-visible:ring-focus-ring/42 data-[active=true]:border-brand/72 data-[active=true]:bg-brand/8 data-[active=true]:text-foreground"
