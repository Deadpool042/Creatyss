  ...
  return (
    <section className="w-full border-b border-shell-border">
      <div className="flex flex-row">
            ...
            <div className="grid gap-3 grid-cols-[auto_1fr] items-start">
              {hasVisibleThumbnailRail ? (
                <div className="order-1">
                  <div className="flex flex-col items-start gap-2.5 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-h-128">
              ...
              <div className="order-2">
                <div className="relative mx-auto aspect-4/5 w-full">
                  <Image
                    ...
                    height={1500}
                    loading="lazy"
                    sizes="(min-width: 1280px) 38vw, (min-width: 1024px) 46vw, 40vw"
        ...
        <aside className="flex w-96 shrink-0 flex-col px-6 py-8 lg:px-8 lg:py-10">
