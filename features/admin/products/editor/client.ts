/**
 * Client-safe barrel for the products editor feature.
 *
 * Only exports types, constants, and server actions — never queries or DB code.
 * Use this in "use client" components instead of the root editor/index.ts barrel.
 */

// Actions — safe in client components ("use server" boundary)
