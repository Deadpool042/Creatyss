...
import { createProductVariantSchema } from "@/features/admin/products/editor/schemas";
import type {
  ProductVariantFormState,
  ProductVariantFormValues,
} from "@/features/admin/products/editor/types/product-variants.types";

function mapFormDataToValues(formData: FormData): Omit<ProductVariantFormValues, "id"> {
  return {
...
export async function createProductVariantAction(
  ...
  return {
    status: "success",
    message: "La variante a été créée.",
    fieldErrors: {},
  };
}
