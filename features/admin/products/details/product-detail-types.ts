...
/**
 * Type riche utilisé par le mapper `mapProductDetails` (interne à details/).
 */
export type AdminProductDetailsFull = {
  id: string;
  slug: string;
  name: string;
...
/**
 * Type public exposé depuis details/ — résultat de readAdminProductDetailsBySlug.
 */
