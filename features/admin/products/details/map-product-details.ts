...
import type { AdminProductDetailsFull } from "./product-detail-types";
...
function mapProductTypeToAdminProductType(input: {
  ...
  variantCount: number;
}): AdminProductDetailsFull["productType"] {
...
export function mapProductDetails(product: ProductDetailsSource): AdminProductDetailsFull {
