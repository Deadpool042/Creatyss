import { getPricingGovernanceData } from "@/features/admin/feature-governance/queries/get-pricing-governance-data.query";
import { getAvailabilityGovernanceData } from "@/features/admin/feature-governance/queries/get-availability-governance-data.query";
import { getCatalogSeoGovernanceData } from "@/features/admin/feature-governance/queries/get-catalog-seo-governance-data.query";
import { getCategoriesGovernanceData } from "@/features/admin/feature-governance/queries/get-categories-governance-data.query";
import { getInventoryGovernanceData } from "@/features/admin/feature-governance/queries/get-inventory-governance-data.query";
import { getMediaGovernanceData } from "@/features/admin/feature-governance/queries/get-media-governance-data.query";
import { getRelatedProductsGovernanceData } from "@/features/admin/feature-governance/queries/get-related-products-governance-data.query";
import { getVariantsGovernanceData } from "@/features/admin/feature-governance/queries/get-variants-governance-data.query";
