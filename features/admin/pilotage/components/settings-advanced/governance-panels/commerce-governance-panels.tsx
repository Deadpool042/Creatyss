...
} from "@/features/admin/pilotage/queries/get-commerce-governance-data.query";
import { getPaymentsGovernanceData } from "@/features/admin/pilotage/queries/get-payments-governance-data.query";
