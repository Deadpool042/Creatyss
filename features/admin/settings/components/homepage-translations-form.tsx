...
import {
  setHomepageTranslationsAction,
  type HomepageTranslationsFormState,
} from "@/features/admin/settings/actions/set-homepage-translations.action";
import type { HomepageTranslationFieldState } from "@/features/admin/settings/queries/list-homepage-translations.query";

const INITIAL: HomepageTranslationsFormState = { status: "idle", message: "" };

type Props = {
  targetLocaleName: string;
  fields: readonly HomepageTranslationFieldState[];
};

function groupFields(
  fields: readonly HomepageTranslationFieldState[]
): { group: string; fields: HomepageTranslationFieldState[] }[] {
  const groups: { group: string; fields: HomepageTranslationFieldState[] }[] = [];
...
export function HomepageTranslationsForm({ targetLocaleName, fields }: Props) {
  const [state, action, isPending] = useActionState(setHomepageTranslationsAction, INITIAL);
