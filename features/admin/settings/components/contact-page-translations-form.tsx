...
import {
  setContactPageTranslationsAction,
  type ContactPageTranslationsFormState,
} from "@/features/admin/settings/actions/set-contact-page-translations.action";
import type { ContactPageTranslationFieldState } from "@/features/admin/settings/queries/list-contact-page-translations.query";

const INITIAL: ContactPageTranslationsFormState = { status: "idle", message: "" };

type Props = {
  targetLocaleName: string;
  fields: readonly ContactPageTranslationFieldState[];
};

function groupFields(
  fields: readonly ContactPageTranslationFieldState[]
): { group: string; fields: ContactPageTranslationFieldState[] }[] {
  const groups: { group: string; fields: ContactPageTranslationFieldState[] }[] = [];
...
export function ContactPageTranslationsForm({ targetLocaleName, fields }: Props) {
  const [state, action, isPending] = useActionState(setContactPageTranslationsAction, INITIAL);
