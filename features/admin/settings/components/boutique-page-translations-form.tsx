...
import {
  setBoutiquePageTranslationsAction,
  type BoutiquePageTranslationsFormState,
} from "@/features/admin/settings/actions/set-boutique-page-translations.action";
import type { BoutiquePageTranslationFieldState } from "@/features/admin/settings/queries/list-boutique-page-translations.query";

const INITIAL: BoutiquePageTranslationsFormState = { status: "idle", message: "" };

type Props = {
  targetLocaleName: string;
  fields: readonly BoutiquePageTranslationFieldState[];
};

function groupFields(
  fields: readonly BoutiquePageTranslationFieldState[]
): { group: string; fields: BoutiquePageTranslationFieldState[] }[] {
  const groups: { group: string; fields: BoutiquePageTranslationFieldState[] }[] = [];
...
export function BoutiquePageTranslationsForm({ targetLocaleName, fields }: Props) {
  const [state, action, isPending] = useActionState(setBoutiquePageTranslationsAction, INITIAL);
