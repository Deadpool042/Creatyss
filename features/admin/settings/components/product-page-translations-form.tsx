...
import {
  setProductPageTranslationsAction,
  type ProductPageTranslationsFormState,
} from "@/features/admin/settings/actions/set-product-page-translations.action";
import type { ProductPageTranslationFieldState } from "@/features/admin/settings/queries/list-product-page-translations.query";

const INITIAL: ProductPageTranslationsFormState = { status: "idle", message: "" };

type Props = {
  targetLocaleName: string;
  fields: readonly ProductPageTranslationFieldState[];
};

function groupFields(
  fields: readonly ProductPageTranslationFieldState[]
): { group: string; fields: ProductPageTranslationFieldState[] }[] {
  const groups: { group: string; fields: ProductPageTranslationFieldState[] }[] = [];
...
export function ProductPageTranslationsForm({ targetLocaleName, fields }: Props) {
  const [state, action, isPending] = useActionState(setProductPageTranslationsAction, INITIAL);
