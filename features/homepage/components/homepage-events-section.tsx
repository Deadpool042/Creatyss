    ...
    >
      <div className="grid gap-5">
        <p className="leading-relaxed text-muted-foreground">
          Tout au long de l'année, Creatyss participe à des rendez-vous locaux pour présenter ses
          créations, rencontrer le public et partager l'univers de l'atelier. Une belle occasion de
          découvrir les pièces de près et d'échanger autour du fait main.
        </p>
        ...
        <div className="rounded-lg border border-surface-border bg-surface-panel-soft p-6 shadow-card">
          ...
          <p className="mt-3 leading-relaxed">
            Venez découvrir les créations Creatyss, échanger autour des pièces exposées et voir les
            détails de fabrication de plus près.
          </p>
        </div>
      </div>
    </SurfaceSection>
