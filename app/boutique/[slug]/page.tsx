...
>(images: readonly TImage[]): TImage | null {
...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  const ogImageUrl =
    product.seoOpenGraphImageUrl ??
    (product.images[0]
      ? getImageUrl(getUploadsPublicPath(), product.images[0].filePath)
      : undefined);
...
export default async function ProductPage({ params, searchParams }: ProductPageProps) {
  ...
  const jsonLdImageUrl = productDisplayImage
    ? getImageUrl(uploadsPublicPath, productDisplayImage.filePath)
    : null;
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Badge variant="outline">
                      <span
                        className={
                          singleOffer.isAvailable ? "text-emerald-700" : "text-destructive"
                        }
                      >
