...
export default async function AdminMaintenanceObservabilityPage() {
  ...
  try {
    ...
    console.error("[maintenance/observability] getAdminSystemHealth failed", error);
  }
              ...
              },
              {
                ...
                value:
                  ...
                  health.events.failed === 0
                    ...
                    : "⚠",
                alert:
                  health.audit.critical > 0 || health.jobs.failed > 0 || health.events.failed > 0,
              ...
              >
                <p
                  className={cn(
                    ...
                    s.alert ? "text-feedback-error-foreground" : "text-foreground"
                  )}
                >
                  {s.value}
                </p>
                ...
                <div className="divide-y divide-surface-border/30 max-h-[32rem] overflow-y-auto">
                  {health.audit.recent.map((log) => {
                    ...
                    return (
                      <div
                        key={log.id}
                        className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-3 px-4 py-2.5 hover:bg-surface-subtle/20 transition-colors"
                      >
                        {/* Level */}
                        <span
                          className={cn(
