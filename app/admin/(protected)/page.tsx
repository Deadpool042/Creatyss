  ...
  return (
    <div className="space-y-8">
      <section className="space-y-2">
        <p className="text-sm font-medium text-muted-foreground">Administration Creatyss</p>
        <h1 className="text-3xl font-semibold tracking-tight text-foreground">Tableau de bord</h1>
        <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
          Bienvenue dans l’espace d’administration. Utilisez les accès rapides ci-dessous pour gérer
          le catalogue, le contenu et les opérations de la boutique.
        </p>
      </section>
