      ...
      <div className="grid gap-6">
        ...
        <section className="rounded-2xl border border-dashed border-surface-border/60 bg-surface-subtle/10 p-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Cette page observe l&apos;etat reel de <code>Integration</code>, <code>IntegrationCredential</code>{" "}
            et <code>IntegrationSyncState</code>. Les prochains increments pourront ajouter les
            ecritures, la reprise operatoire et les adaptateurs provider, mais rien de cela
            n&apos;est ouvert ici.
          </p>
          <Link
