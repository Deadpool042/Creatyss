      ...
      <div className="grid gap-6">
        ...
        <section className="rounded-2xl border border-dashed border-surface-border/60 bg-surface-subtle/10 p-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            fiche produit. Les prochains increments pourront trancher les
            providers supportes, les taches autorisees, les validations humaines
            et les autres surfaces de generation.
          </p>
          <Link
