...
- `engagement.newsletter` : campagnes réelles implémentées (création, prévisualisation, envoi avec invariants RGPD, suivi recipients) au 2026-07-02 — recette manuelle Mailpit restante, cf. `lot-newsletter-campagnes.md`
...
| [lot-newsletter-campagnes.md](./lot-newsletter-campagnes.md)               | Créer et envoyer des campagnes newsletter réelles                              | Implémenté (code) — 2026-07-02, recette manuelle Mailpit restante                                                   |
