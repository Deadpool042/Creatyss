...
| D   | `MaintenanceRouteNav` (logs, monitoring, observability à la livraison ; fusionné à 2 entrées — Vue d'ensemble, Jobs — par le lot 15 `admin-design-macos`, 2026-07-06)  | S      | —           | Livré (295d922f)                 |
