...
| [lot-implementation-nav-admin.md](./lot-implementation-nav-admin.md)       | Micro-lots d'implémentation de la nouvelle navigation, groupe par groupe          | Terminé — options B et A livrées, 6 domaines fusionnés (customers, catalog, orders, media, payments, shipping) |
| [lot-audit-completude-storefront.md](./lot-audit-completude-storefront.md) | Vérifier chaque page publique contre les horizons H1-H4 livrés, lister les écarts | Livré — 2026-07-03, 1 bug corrigé (formulaire suivi de commande cassé)                                         |
