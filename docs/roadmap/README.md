...
| Analyses — cockpit analytique     | Étendre le cockpit `/admin/insights/analytics` (ventes, comportement, conversion, recherche)        | Terminé — 6 lots livrés (top pages Umami, tracking recherche, relance panier abandonné, attribution externe assumée, cockpit consolidé, domaines tracking/dashboarding matérialisés), mergé dans main (2026-07-06) |
