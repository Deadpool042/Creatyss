...
| Hygiène composition storefront    | Empty states, formulaires, valeurs Tailwind arbitraires sur `app/(public)/**`                       | Terminé — 5 lots livrés (2026-07-07) : classe morte supprimée, empty states unifiés, formulaires alignés, valeurs Tailwind arbitraires remplacées, `bg-white/80` remplacé par token                 |
