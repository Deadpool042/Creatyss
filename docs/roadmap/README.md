...
| Analyses — cockpit analytique     | Étendre le cockpit `/admin/insights/analytics` (ventes, comportement, conversion, recherche)        | Presque terminé — 6 lots livrés, mergé dans main (2026-07-06) ; lot 7 cadré suite à audit (effet de bord panier abandonné côté storefront), décision en attente                                     |
