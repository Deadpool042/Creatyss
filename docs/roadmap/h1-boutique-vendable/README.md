...
- Stripe non intégré (`commerce.payments` = virement bancaire uniquement, observé dans `2026-06-13-audit-catalogue-modules.md`)
...
- Recette humaine complète en production non effectuée (non documentée comme réalisée)
...
| ------------------------------------------------------------ | -------------------------------------------------------------------- | ------- |
| [lot-paiement-en-ligne.md](./lot-paiement-en-ligne.md)       | Intégration Stripe pour accepter les paiements par carte             | A faire |
