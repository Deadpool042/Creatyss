...
- `V21-3` dépend de `V21-1`, `V21-2A` et `V21-2B` : V21-3 ne démarre qu'après la finalisation complète de la façade pilote `catalog` (V21-2A + V21-2B), afin que le pattern de modularisation interne soit entièrement validé avant de l'appliquer au domaine `order`
