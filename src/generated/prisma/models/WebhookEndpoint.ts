...
export type WebhookEndpointGroupByOutputType = {
  ...
  subscribedEvents: runtime.JsonValue
  lastDeliveredAt: Date | null
  lastFailedAt: Date | null
  createdAt: Date
  updatedAt: Date
...
export type WebhookEndpointWhereInput = {
  ...
  subscribedEvents?: Prisma.JsonFilter<"WebhookEndpoint">
...
export type WebhookEndpointScalarWhereWithAggregatesInput = {
  ...
  subscribedEvents?: Prisma.JsonWithAggregatesFilter<"WebhookEndpoint">
...
export type WebhookEndpointCreateInput = {
  ...
  secretHash: string
  status?: $Enums.WebhookStatus
  subscribedEvents: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type WebhookEndpointOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "storeId" | "code" | "name" | "description" | "url" | "secretHash" | "status" | "subscribedEvents" | "lastDeliveredAt" | "lastFailedAt" | "createdAt" | "updatedAt", ExtArgs["result"]["webhookEndpoint"]>
...
export interface WebhookEndpointFieldRefs {
  ...
  readonly subscribedEvents: Prisma.FieldRef<"WebhookEndpoint", 'Json'>
