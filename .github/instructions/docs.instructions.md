---
applyTo: "README.md,AGENTS.md,docs/**/*.md,.claude/**/*.md,.codex/**/*.md"
---

# Documentation instructions

- Documentation must reflect the real repository state.
- Do not present future architecture as if it already exists.
- Use the current architecture tree as source of truth:
