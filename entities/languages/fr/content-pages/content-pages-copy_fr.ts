/**
 * Dictionnaire français des pages de contenu d'instance.
 *
 * Source de référence pour `a-propos`, `les-marches` et `contact`.
 * Les valeurs sont identiques à l'ancienne config storefront : ce déplacement
 * ne modifie aucun rendu.
 */
export const CONTENT_PAGES_COPY_FR = {
  aPropos: {
    metadata: {
