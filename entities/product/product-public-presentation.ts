...
export function getProductOfferSectionPresentation(
  ...
  if (productType === "simple") {
    return {
      ...
      emptyDescription: "Les informations de vente ne sont pas disponibles actuellement.",
    };
  }
  ...
  return {
    ...
    emptyDescription: "Les déclinaisons apparaîtront ici lorsqu'elles seront disponibles.",
  };
}
