export function OrientationGuard() {
  return (
    <div
      aria-live="polite"
      className="fixed inset-0 z-9999 hidden place-items-center bg-background px-6 text-center text-foreground [@media(orientation:landscape)_and_(max-height:500px)]:grid"
    >
