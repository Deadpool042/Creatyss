...
export function AdminProductCard({ product }: AdminProductCardProps) {
  const presentation = getAdminProductPresentation(product.productType, product.variantCount);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge variant="outline">{presentation.typeLabel}</Badge>
        ...
        <Badge variant="outline">{presentation.sellableCountLabel}</Badge>
      </div>
