...
import { AdminLogoutButton } from "@/components/admin/shared/admin-logout-button";
  ...
  return (
    <Sidebar collapsible="offcanvas" className="border-r border-sidebar-border bg-sidebar">
      <SidebarHeader className="border-b border-sidebar-border p-1.5 desktop:p-2">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="rounded px-2 laptop:h-11 desktop:h-12">
      ...
      <SidebarFooter className="border-t border-sidebar-border p-1.5 desktop:p-2">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" className="rounded px-2 laptop:h-11 desktop:h-12">
