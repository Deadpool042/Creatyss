...
export function AdminDataTableMobileTopbar({
  ...
  return (
    <div
      className={cn("flex w-full items-center gap-2 [@media(max-height:480px)]:gap-1.5", className)}
    >
      <div
        className={cn(
          "flex min-w-0 flex-1 items-center gap-2 [@media(max-height:480px)]:gap-1.5",
          controlsClassName
        )}
      >
        <AdminSearchInput
