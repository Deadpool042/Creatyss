...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] rounded-lg border border-control-border bg-control-surface p-0.5 shadow-control data-[spacing=0]:gap-0 data-[spacing=0]:p-0 data-[size=sm]:rounded-[min(var(--radius-md),10px)] data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
