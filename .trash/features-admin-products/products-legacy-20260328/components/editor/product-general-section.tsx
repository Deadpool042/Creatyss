      ...
      <form action={updateProductAction} className="space-y-4">
        ...
        >
          <div className="grid gap-5 md:grid-cols-2">
            <AdminFormField htmlFor={nameId} label="Nom">
              <Input defaultValue={product.name} id={nameId} name="name" required type="text" />
            </AdminFormField>

            <AdminFormField htmlFor={slugId} label="Slug">
              <Input defaultValue={product.slug} id={slugId} name="slug" required type="text" />
            </AdminFormField>
          </div>

          <AdminFormField htmlFor={shortDescriptionId} label="Description courte">
            <Textarea
          ...
          <AdminFormField htmlFor={descriptionId} label="Description">
            <Textarea
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <AdminFormField htmlFor={seoTitleId} label="Titre SEO">
              <Input
            ...
            <AdminFormField htmlFor={seoDescriptionId} label="Description SEO">
              <Textarea
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <AdminFormField htmlFor={productTypeId} label="Type de produit">
              <select
                className={nativeSelectClassName}
                ...
                {categories.map((category) => (
                  ...
                  >
                    <input
                      ...
                      defaultChecked={isCategoryAssigned(product.categoryIds, category.id)}
                      name="categoryIds"
                      type="checkbox"
                      value={category.id}
                    />
